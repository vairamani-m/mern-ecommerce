...
const userControl = {
    register: async (req, res)=>{
        try {
            ...
            // Then create jsonwebtoken(JWT) to authentication
    ...
    refreshToken: async(req, res) => {
        try {
            ...
            if(!rf_token) return res.json({ message: "Please Login or Register"})
            jwt.verify(rf_token, process.env.REFRESH_TOKEN_SECRET, (err, user)=> {
                if(err) return res.json({ message: "Please Login or Register"})
